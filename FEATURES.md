...
- Add GPU OpenSubdiv support (CPU-side Catmull-Clark via Embree 4 is already implemented; this entry tracks future GPU-accelerated subdivision via OpenSubdiv).
