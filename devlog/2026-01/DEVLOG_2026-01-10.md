...
### 6. Merge instance buffers

- Single buffer holds [near_instances... | far_instances...]
- Removed separate `lod_box_instance_buffer`
- Far instances accessed via byte offset slice in render pass
- Reduces GPU buffer count and simplifies memory layout
- Commit: `perf: merge near/far instance buffers`

## Commits This Session

```text
c3f0bd8 perf: merge near/far instance buffers
...
- wgpu buffer slices allow different vertex buffer regions per draw call

## Next Session

- Milestone 15 (Materials/MaterialX)
- Consider GPU compute culling for 100K+ scale

## Wiki Links

- [[wgpu-pipeline|wgpu Pipeline]] — GPU frustum culling and compute shader considerations
- [[materialx-bridge|MaterialX Bridge]] — MaterialX material system exploration
