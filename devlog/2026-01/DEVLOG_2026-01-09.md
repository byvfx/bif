...
- [[bif-usd-integration|BIF USD Integration]] — USD winding order detection, C++ bridge memory management
- [[geometry-schemas|Geometry Schemas]] — mesh rendering and normal handling
- [[wgpu-pipeline|wgpu Pipeline]] — renderer bug fixes
