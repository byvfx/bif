# BIF Milestone History

Complete history of BIF development milestones. For the current roadmap, see [MILESTONES.md](MILESTONES.md).
...
- **Key Achievements:**
  ...
  **Phase 5b: Viewport Camera Selection ✅ (M19.3)**
...
| 29 | USD Export | Import → modify → render → export pipeline | ✅ Complete |
| 29.5 | egui UI Overhaul | Theme, layout, discoverability | ✅ Complete |
| 30 | Persistence + Eval Modes | Save/load .bif/.bifa, cache node, cook modes | ✅ Complete |
| 31 | Per-Node Scene Graph Viz | Click node → see tree at that eval point | ✅ Complete |
...
## Historical Milestone Organization Principles

These are the original principles used during development, before the semver transition.
