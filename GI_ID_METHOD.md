...
* **Cache Heatmap AOV** — Switch Alets OV channel to `CacheHeatmap`. Green = well-cached regions, black = no cache data. Useful for spotting dead zones (geometry outside hash range, or cell_size too small).
